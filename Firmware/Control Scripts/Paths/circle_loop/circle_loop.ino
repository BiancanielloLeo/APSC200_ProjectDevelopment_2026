// =============================================================================
// CIRCLE LOOP — pure pursuit path following
// =============================================================================
//
// Drives a single circle of radius CIRCLE_RADIUS_M centred on
// (CIRCLE_CENTER_X, CIRCLE_CENTER_Y) in the camera's world frame, forever.
//
...
// true  = counter-clockwise (left turn, positive omega)
// false = clockwise
bool  CIRCLE_CCW        = true;

// Spacing between generated waypoints. Smaller = smoother goal selection but
// more points. 0.05 m gives ~75 points at r = 0.60.
